...
[LVAgent: Long Video Understanding by Multi-Round Dynamical Collaboration of MLLM Agents](https://arxiv.org/pdf/2503.10200)<br>
　-> MLLMエージェントによる長尺動画理解に関する論文

[gpt-oss-120b & gpt-oss-20b Model Card](https://arxiv.org/pdf/2508.10925)<br>
　-> gpt-ossモデルのモデルカードに関する論文
